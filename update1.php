...
$year=$_POST['year'];
$cat=$_POST['category'];
$query="update  project set title=? , year=? ,  category=?  where id=?";
$stmt=mysqli_stmt_init($conn);
mysqli_stmt_prepare($stmt,$query);
mysqli_stmt_bind_param($stmt,"ssss",$title,$year,$cat,$id);
mysqli_stmt_execute($stmt);
$query1="update  team_details   set student1=?, student2=?,student3=? ,student4=? , roll1=? ,roll2=? , roll3=? , roll4=? ,mentor=?  where id=?"; 
