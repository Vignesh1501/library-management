...
<table class='ui   table'>
  ...
  <tbody>";
$query="select top_project.*,top_team_detail.* from  top_project,top_team_detail where top_project.id=top_team_detail.id and category='$btech'";
...
<div class='ui compact menu'>
  ...
  <a> More</a>
    ...
    <div class='menu'>
      ...
      <div class='item'><i class='edit icon' onclick='hello3({$eid})'></i><button class='tiny ui yellow button'  onclick='hello3({$eid})'>Edit</button></div>
